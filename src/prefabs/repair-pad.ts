...
export const createRepairPad = (gameWorld: World, position: Vec2, angle: number, owner: GameClient): Entity => {
  ...
  // Create AI entity
  const entity = new Entity(EntityId.RepairPad, gameWorld, owner);
  ...
  entity.addComponent(new RepairStructuresInRange(1, 10, 5));
