...
export const createWallWooden = (gameWorld: World, position: Vec2, angle: number, owner: GameClient): Entity => {
  ...
  // Create entity
  const entity = new Entity(EntityId.WallWooden, gameWorld, owner);
  entity.addComponent(new Health(300));
